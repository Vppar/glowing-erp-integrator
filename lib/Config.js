...
config.CONSULTANT_SUBSCRIPTION_REQUEST_QUEUE_REF = 'queues/subscription-consultant-update/pending';
config.CONSULTANT_SUBSCRIPTION_UPDATE_QUEUE_REF = 'queues/subscription-consultant-request/pending';
