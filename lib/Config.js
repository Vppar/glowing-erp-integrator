...
config.TOKEN_VPSA = 'df881a35fdff9b8d5263f27b2e361b0e6239d6e27a4a2dc2a921155a8ba49428';
...
config.billet.CARTEIRADECOBRANCA = 4;

config.order = {};
config.order.ENTIDADE = 6;
config.order.REPRESENTANTE = 1;
config.order.SERVICO = 1;
...
config.EMAIL_MANDRILL_KEY = 'ThAov6-v1NGYltiq9NFAUQ';
