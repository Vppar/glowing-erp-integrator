...
config.subscription = {};
config.subscription.consumer = {};
config.subscription.consumer.CHILD = 'pending/subscriptionAdd';
config.subscription.consumer.EVENTTYPE = 'child_added';
config.subscription.paymentType = {};
config.subscription.paymentType.BILLET = 'billet';
