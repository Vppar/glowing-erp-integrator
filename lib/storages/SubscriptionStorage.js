...
SubscriptionStorage.pushSubscriptionFailMessage = function (subscription, message, callback) {
	var subscriptionFailMessage = {};
	subscriptionFailMessage.subscription = subscription;
	subscriptionFailMessage.message = message;

	FirebaseBackend.push(FirebaseBackend.refs.base.child(Config.CONSULTANT_SUBSCRIPTION_REQUEST_QUEUE_FAILED_REF), subscriptionFailMessage, callback);
};