...
BilletController.handleBillet = function (subscription, callback) {  
  console.log('\n[BilletController.handleBillet][Starting service...]');
	async.series([		  
  		function(callback) {
    		CustomerService.createNewCustomer(subscription, callback)
  		},
  		function(callback) {
...
BilletController.verifyBilletStatus = function (subscription, callback) {
	BilletService.verifyBilletStatus(subscription, callback);
};