...
SubscriptionController.createSubscription = function ( subscriptionSnapshot ){
	return createSubscriptionInitialValues(subscriptionSnapshot);
}

SubscriptionController.handleSubscription = function (subscription, callback) {  
  console.log('[SubscriptionController.handleSubscription][Starting service...]');
	async.series([
	function(callback) {
...
SubscriptionController.getPengingUserActionSubscriptions = function (callback) {
  console.log('[SubscriptionController.handlePaymentStatusProcess][Starting service...]');
