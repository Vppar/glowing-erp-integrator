  ...
  function handler(req, res) {
    async.waterfall([
      ...
      if(err) {
        ...
        console.log('\n[ConsultantSubscriptionRequestWorker.handleBilletsPaymentStatusProcess][Worker flow executed with errors: '+ err+']');
        //return;
      } else {
        console.log(null, '\n[ConsultantSubscriptionRequestWorker.handleBilletsPaymentStatusProcess][Worker flow executed successfully: '+ results+']');
