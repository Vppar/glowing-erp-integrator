...
CustomerService.adaptCustomerToTerceiroVPSA = function(terceiroVPSA, customer){
	...
	console.log(terceiroVPSA);
	var endereco = {
		tipo: 'RUA',
		logradouro: customer.address.street,
		numero: customer.address.number,
		bairro: 'bairro teste', 	//TODO: verificar
		complemento: customer.complement,
		cep: customer.cep,
		codigoIBGECidade: '3549904' //são jose dos campos //TODO:verificar
	}
	
	var telefoneI = { numero: customer.phone } 	
	var telefoneII = { numero: customer.cellphone }
	...
	terceiroVPSA.telefones = [telefoneI, telefoneII];
