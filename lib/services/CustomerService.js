...
function getAddress(subscriptionUUID, consultant) {
	...
	var endereco = {
		tipo: type,
		logradouro: StringUtils.removeAddressInvalidCharacter(street),
		numero: consultant.address.number,
		bairro: StringUtils.removeAddressInvalidCharacter(consultant.address.neighborhood),
		complemento: StringUtils.removeAddressInvalidCharacter(consultant.complement),
		cep: consultant.cep,
