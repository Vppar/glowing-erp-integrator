...
SubscriptionService.validateSubscriptionBeforeContinueFlow = function (subscriptionToValidate, callback){
	...
	if(!subscriptionToValidate){
		...
		if(!consultant.subscriptionExpirationDate){
			messageValidation.push('subscription.subscriptionExpirationDate is empty');
		}else if(typeof consultant.subscriptionExpirationDate !== 'number'){
