...
function notifyGlowingRestApi(subscription, status) {
	...
	var subscriptionConsultantUpdate.newSubscriptionExpirationDate = defineNewExpirationDate(subscription);
	var subscriptionConsultantUpdate.consultantUUID = subscription.consultant.uuid;
