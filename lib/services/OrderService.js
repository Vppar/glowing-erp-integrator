...
OrderService.adaptSubscriptionToOrderService = function(orderService, subscription){
	...
	orderService.data = OrderService.getCurrentDate();
	orderService.horario = OrderService.getCurrentHour();
...
OrderService.getCurrentDate = function(callback){
...
OrderService.getCurrentHour = function(){
