...
=======
	}else if(newOrderService.idPlanoPagamento != VPSASubscriptionPlanType.CASH && newOrderService.idPlanoPagamento != VPSASubscriptionPlanType.SIXTIMES && newOrderService.idPlanoPagamento != VPSASubscriptionPlanType.TWELVETIMES)	{
		callback('[OrderService.createNewOrderService][Error: idPlanoPagamento attribute is invalid]');
>>>>>>> Temporary merge branch 2
		validation = false;
